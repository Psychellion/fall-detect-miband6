...
from pipeline.inference import TFInferenceEngine
from pipeline.pose_engine import PoseEngine
import tensorflow
import logging
import math
import time
...
DEFAULT_DATA_DIR = "D:\GLYCELLE\THESIS FINAL OUTPUTS\System Code"
...
class FallDetector():
    ...
    def __init__(self,model=None,
        ...
        {
            'tensorflow': 
                'ai_models/posenet_mobilenet_v1_100_257x257_multi_kpt_stripped.tensorflow'
            'edgetpu': 
                'ai_models/posenet_mobilenet_v1_075_721_1281_quant_decoder_edgetpu.tensorflow'
        }
        """
        ...
        log.debug(f"Initializing FallDetector with confidence threshold: \ {self.confidence_threshold}")
